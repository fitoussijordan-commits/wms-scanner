...
export const FIELD_DEFS = {
  ...
  PICKING_DATE: { default: "date", model: "stock.picking", label: "Date (création/mouvement)",
    hint: "⚠️ Peut ne plus exister tel quel sur certaines versions récentes d'Odoo (ex. v19) — utilisé pour le tri « Par date » de l'écran Préparation.",
    screens: ["prep"],
  },
  ...
  ML_PRODUCT_ID: { default: "product_id", model: "stock.move.line", label: "Produit (ligne)",
    screens: ["prep", "packing", "transfer", "inventoryCount", "returns", "arrival"],
  },
  ...
  MOVE_PRODUCT_ID: { default: "product_id", model: "stock.move", label: "Produit (move)",
    screens: ["prep", "packing", "arrival", "returns"],
  },
  ...
  QUANT_PRODUCT_ID: { default: "product_id", model: "stock.quant", label: "Produit (quant)",
    screens: ["inventory", "inventoryCount", "freeScan", "negativeStock", "locationManager"],
  },
  ...
  LOCATION_NAME: { default: "name", model: "stock.location", label: "Nom emplacement",
    screens: ["transfer", "inventory", "inventoryCount", "freeScan", "locationManager", "prep"],
  },
  ...
  LOT_NAME: { default: "name", model: "stock.lot", label: "Nom du lot",
    screens: ["prep", "packing", "inventoryCount", "freeScan", "fefo", "arrival"],
  },
  ...
  SALE_NAME: { default: "name", model: "sale.order", label: "Référence commande de vente",
    screens: ["waitingOrders", "prep", "packing", "order"],
  },
  ...
  SUPPLIERINFO_PRODUCT_CODE: { default: "product_code", model: "product.supplierinfo", label: "Code produit fournisseur (supplierinfo)",
    screens: ["supplierImport", "arrival", "productImport"],
  },
  ...
  PARTNER_NAME: { default: "name", model: "res.partner", label: "Nom partenaire",
    screens: ["order", "packing", "waitingOrders"],
  },
  ...
  ATTACH_DATAS: { default: "datas", model: "ir.attachment", label: "Données (base64)",
    screens: ["packing", "reprintLabel", "prep"],
  },
