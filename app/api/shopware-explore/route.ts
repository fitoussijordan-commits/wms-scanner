...
// binSetStock a ete retire : l'API Pickware ne sait pas mettre a jour un
// emplacement existant — son PUT valide le code comme une CREATION et refuse
// un code deja pris. L'affectation d'emplacement reste a faire dans Shopware.
const WRITE_ACTIONS = new Set(["setStock", "duplicateOrder", "cancelOrder"]);
